...
import { faSearch, faShoppingBag, faUser, faBars, faMapMarkerAlt, faEnvelope, faSignOutAlt } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="d-flex justify-content-between">
                    <div className="top-info ps-2">
                        <small className="me-3">
                            ...
                            <Link to="/" className="text-white">123 Street, New York</Link>
                        </small>
                        <small className="me-3">
